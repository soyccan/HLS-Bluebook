...
#ifndef _shift_reg_ip_Sregbkb_H_
#define _shift_reg_ip_Sregbkb_H_
#include <systemc>
#include <iostream>
#include <fstream>
#include "AESL_pkg.h"
...
struct shift_reg_ip_Sregbkb_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(shift_reg_ip_Sregbkb_core);
    shift_reg_ip_Sregbkb_core(sc_core::sc_module_name) {
        SC_METHOD(proc_dout);
...
SC_MODULE( shift_reg_ip_Sregbkb )
{
    ...
    SC_CTOR( shift_reg_ip_Sregbkb ) {
        meminst = new shift_reg_ip_Sregbkb_core <DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    shift_reg_ip_Sregbkb_core <DataWidth, AddressWidth, AddressRange>* meminst;

};

#endif //_shift_reg_ip_Sregbkb_H_
