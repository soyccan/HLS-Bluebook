...
#ifndef _shift_reg_basic_HH_
#define _shift_reg_basic_HH_
...
struct shift_reg_basic : public sc_module {
    ...
    // Module declarations
    shift_reg_basic(sc_module_name name);
    SC_HAS_PROCESS(shift_reg_basic);
