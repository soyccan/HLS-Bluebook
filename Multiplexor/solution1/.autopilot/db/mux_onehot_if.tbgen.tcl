...
set C_modelArgMapList {[ 
	{ "Name" : "din_0_V_read", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sel_V", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sel_V", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sel_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sel_V { ap_none {  { sel_V in_data 0 8 } } }
}
