...
set C_modelArgMapList {[ 
	{ "Name" : "din_0_V_read", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sel_V", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_ready", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "ready", "bundle":{"name": "ap_ready", "role": "default" }} , 
 	...
 	{ "name": "sel_V", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sel_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.top_mux_83_8_1_1_U53", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	sel_V { ap_none {  { sel_V in_data 0 3 } } }
}
