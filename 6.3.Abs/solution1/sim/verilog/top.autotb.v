...
`define AUTOTB_TVIN_val_V_out_wrapc  "../tv/rtldatafile/rtl.top.autotvin_val_V.dat"
...
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.top.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 45;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1;
parameter LENGTH_val_V = 1;
...
// The signal of port val_V
reg [7: 0] AESL_REG_val_V = 0;
assign val_V = AESL_REG_val_V;
initial begin : read_file_process_val_V
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_val_V,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_val_V);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_val_V);
              if (ret != 1) begin
