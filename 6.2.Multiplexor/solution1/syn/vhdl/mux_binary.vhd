...
architecture behav of mux_binary is 
    constant ap_const_logic_1 : STD_LOGIC := '1';
    constant ap_const_boolean_1 : BOOLEAN := true;
    constant ap_const_logic_0 : STD_LOGIC := '0';

    signal tmp_fu_78_p10 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    top_mux_83_8_1_1_U53 : component top_mux_83_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
