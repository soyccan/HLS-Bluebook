...
entity mux_binary2onehot_op is
port (
...
architecture behav of mux_binary2onehot_op is 
    constant ap_const_logic_1 : STD_LOGIC := '1';
    constant ap_const_boolean_1 : BOOLEAN := true;
    constant ap_const_logic_0 : STD_LOGIC := '0';

    signal tmp_V_fu_140_p0 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_fu_96_p10 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_1_fu_118_p10 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    top_mux_83_8_1_1_U22 : component top_mux_83_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    top_mux_83_8_1_1_U23 : component top_mux_83_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    ap_return <= 
        tmp_fu_96_p10 when (tmp_V_fu_140_p0(0) = '1') else 
        tmp_1_fu_118_p10;
    tmp_V_fu_140_p0 <= (0=>s, others=>'-');
end behav;
