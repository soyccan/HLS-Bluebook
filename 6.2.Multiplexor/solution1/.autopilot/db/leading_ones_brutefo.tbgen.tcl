set moduleName leading_ones_brutefo
set isTopModule 0
...
set C_modelName {leading_ones_brutefo}
set C_modelType { int 6 }
set C_modelArgList {
	{ din_V int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "din_V", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "din_V", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "din_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	din_V { ap_none {  { din_V in_data 0 32 } } }
}
