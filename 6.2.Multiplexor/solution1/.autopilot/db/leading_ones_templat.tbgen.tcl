set moduleName leading_ones_templat
set isTopModule 0
...
set C_modelName {leading_ones_templat}
set C_modelType { int 6 }
set C_modelArgList {
	{ din_V_read int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "din_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "ap_return", "interface" : "wire", "bitwidth" : 6} ]}
# RTL Port declarations: 
set portNum 4
set portList { 
	{ ap_ready sc_out sc_logic 1 ready -1 } 
	{ din_V_read sc_in sc_lv 32 signal 0 } 
	{ ap_return_0 sc_out sc_lv 1 signal -1 } 
	{ ap_return_1 sc_out sc_lv 5 signal -1 } 
}
set NewPortList {[ 
	{ "name": "ap_ready", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "ready", "bundle":{"name": "ap_ready", "role": "default" }} , 
 	{ "name": "din_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "din_V_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ret_leading_ones_32_s_fu_12", "Parent" : "0",
...
set Spec2ImplPortList { 
	din_V_read { ap_none {  { din_V_read in_data 0 32 } } }
}
