...
if {[file isfile shift_reg.autotvin.dat]} {
	file delete -force shift_reg.autotvin.dat
}

if {[file isfile shift_reg.autotvout.dat]} {
	file delete -force shift_reg.autotvout.dat
}
