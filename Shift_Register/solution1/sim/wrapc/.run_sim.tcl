...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "shift_reg.autotvin.dat"
	set constFileTvOut       "shift_reg.autotvout.dat"
	set constFileHdlTvIn     "shift_reg.autohdltvin.dat"
	set constFileHdlTvOut    "shift_reg.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
