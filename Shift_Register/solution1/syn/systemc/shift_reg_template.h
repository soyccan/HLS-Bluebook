...
#ifndef _shift_reg_template_HH_
#define _shift_reg_template_HH_
...
struct shift_reg_template : public sc_module {
    ...
    // Module declarations
    shift_reg_template(sc_module_name name);
    SC_HAS_PROCESS(shift_reg_template);
